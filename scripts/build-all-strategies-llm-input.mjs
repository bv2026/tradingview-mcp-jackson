...
const strategyContexts = {
  ...
  futures: { instrument_type: 'futures', universe: 'Approved futures universe', policy: 'bidirectional', score_semantics: 'Futures evidence-state score; strategy-local', authoritative_evidence: ['TradingView futures evidence (TWB / NW / regime / S/R)'], allowed_provider_context: ['TradingView futures context only'], eligibility_semantics: 'Futures setup/direction/entry eligibility with manual R:R gate', manual_checks: ['live levels', 'stop/target', 'manual R:R', 'contract conditions'], allowed_inference: 'Infer direction only from approved futures evidence and explicit provider conflicts.', prohibited_inference: 'Do not use futures score or bias to influence equities or crypto.' },
  crypto: { instrument_type: 'crypto_spot', universe: 'Approved crypto spot universe', policy: 'long-only', score_semantics: 'Crypto spot evidence-state score; strategy-local', authoritative_evidence: ['TradingView crypto evidence', 'Coinbase Weekly context where present'], allowed_provider_context: ['Approved TradingView and Coinbase context only'], eligibility_semantics: 'Spot eligibility; bearish evidence cannot create a short', manual_checks: ['live chart', 'location', 'stop/target', 'freshness'], allowed_inference: 'Infer long-side setup quality from approved spot evidence.', prohibited_inference: 'Never infer a short or import perp/futures direction.' },
  crypto_perps: { instrument_type: 'crypto_perp', universe: 'Approved perpetual-futures crypto universe', policy: 'bidirectional', score_semantics: 'Crypto perp evidence-state score; strategy-local', authoritative_evidence: ['TradingView perp evidence', 'BTC session/broad crypto context', 'Coinbase Weekly context where present'], allowed_provider_context: ['Approved TradingView/Coinbase context plus BTC session and broad crypto context'], eligibility_semantics: 'Perp bidirectional eligibility with live funding/positioning checks', manual_checks: ['live funding', 'positioning', 'BTC session context', 'stop/target', 'freshness'], allowed_inference: 'Use BTC/broad context only as explicitly supplied in this perp model.', prohibited_inference: 'Do not transfer perp signals to spot, futures, or equities.' },
};
